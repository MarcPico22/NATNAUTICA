  ...
  return (
    <div className="fixed inset-x-0 bottom-4 z-50 px-4">
      <div className="mx-auto flex max-w-4xl flex-col gap-4 rounded-3xl border border-slate-200 bg-white p-6 shadow-2xl dark:border-slate-800 dark:bg-slate-900">
        <div>
          <h2 className="text-sm font-semibold text-slate-900 dark:text-white">{t('cookieBanner.title')}</h2>
          <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">{t('cookieBanner.description')}</p>
        </div>
