...
export const starlinkBlogPost = {
  ...
  `,
            seo: {
                ...
                metaDescription: 'Descubre cómo Starlink está revolucionando las comunicaciones marítimas con internet de alta velocidad, baja latencia y cobertura global para yates en cualquier rincón del océano.',
                keywords: ['starlink yates', 'internet satelital', 'conectividad marina', 'starlink maritime', 'comunicaciones náuticas']
            }
        },
        en: {
            title: 'Starlink for Yachts: A Revolution in Marine Satellite Connectivity',
  ...
  `,
            seo: {
                ...
                metaDescription: 'Discover how Starlink is revolutionizing maritime communications with high-speed internet, low latency, and global coverage for yachts anywhere in the ocean.',
                keywords: ['starlink yachts', 'satellite internet', 'marine connectivity', 'starlink maritime', 'nautical communications']
            }
        },

        fr: {
            title: 'Starlink pour Yachts : Une Révolution dans la Connectivité Satellite Marine',
  ...
  `,
            seo: {
                metaTitle: 'Starlink pour Yachts : Connectivité Satellite Marine | Netnautica',
                metaDescription: 'Découvrez comment Starlink révolutionne les communications maritimes avec un internet haut débit, une faible latence et une couverture mondiale pour yachts en haute mer.',
                keywords: ['starlink yachts', 'internet satellite', 'connectivité marine', 'starlink maritime', 'communications nautiques']
            }
        },

        de: {
            title: 'Starlink für Yachten: Eine Revolution in der maritimen Satellitenkonnektivität',
  ...
  `,
            seo: {
                ...
                metaDescription: 'Entdecken Sie, wie Starlink die maritime Kommunikation revolutioniert – mit Hochgeschwindigkeitsinternet, niedriger Latenz und globaler Abdeckung für Yachten auf hoher See.',
                keywords: ['starlink yachten', 'satelliteninternet', 'marine konnektivität', 'starlink maritime', 'nautische kommunikation']
            }
        }
    },
    ...
    featuredImage: {
        ...
        alt: 'Yate equipado con antena satelital Starlink',
        width: 1200,
        height: 630
    },
    seo: {
